    ...
    <div className="min-h-screen bg-[#F8F4E9] overflow-x-hidden">
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
            {[
              { icon: Users, number: "10+", label: t.yearsExperience, color: "#E3AE2C" },
              { icon: Globe, number: "25+", label: t.countriesServed, color: "#17472F" },
              { icon: Award, number: "1000+", label: t.happyClients, color: "#E3AE2C" },
              { icon: Truck, number: "50+", label: t.products, color: "#17472F" },
            ].map((stat, index) => (
